...
public class Assets {
    ...
    public static void initializeObjects() {
        ...
        // create hiding spots
        HidingSpot chapin1 = new HidingSpot("", "", CampusMap.chapinLawn, 1.25);
        HidingSpot chapin2 = new HidingSpot("", "", CampusMap.chapinLawn, 1.0);
        HidingSpot chapin3 = new HidingSpot("", "", CampusMap.chapinLawn, 1.0);
        HidingSpot capenGazebo = new HidingSpot("Garden Gazebo", "under gazebo", CampusMap.capenGarden, 1.5);
        HidingSpot capenPorch = new HidingSpot("Back Porch", "porch", CampusMap.capenGarden, 1.5);
        HidingSpot capenFlowers = new HidingSpot("Flower Bed", "", CampusMap.capenGarden, 1.25);
        HidingSpot burton1 = new HidingSpot("", "", CampusMap.burtonLawn, 1.5);
        HidingSpot burton2 = new HidingSpot("", "", CampusMap.burtonLawn, 1.0);
        HidingSpot burton3 = new HidingSpot("", "", CampusMap.burtonLawn, 1.0);
        HidingSpot neilson1 = new HidingSpot("", "", CampusMap.neilsonLawn, 1.25);
        HidingSpot neilson2 = new HidingSpot("", "", CampusMap.neilsonLawn, 1.0);
        HidingSpot neilson3 = new HidingSpot("", "", CampusMap.neilsonLawn, 0.75);
        HidingSpot mendenhall1 = new HidingSpot("", "", CampusMap.mendenhallCourtyard, 1.5);
        HidingSpot mendenhall2 = new HidingSpot("", "", CampusMap.mendenhallCourtyard, 1.25);
        HidingSpot mendenhall3 = new HidingSpot("", "", CampusMap.mendenhallCourtyard, 1.0);
        HidingSpot quad1 = new HidingSpot("", "", CampusMap.greatQuadrangle, 1.0);
        HidingSpot quad2 = new HidingSpot("", "", CampusMap.greatQuadrangle, 0.75);
        HidingSpot quad3 = new HidingSpot("", "", CampusMap.greatQuadrangle, 0.75);
        HidingSpot athletic1 = new HidingSpot("", "", CampusMap.athleticField, 1.25);
        HidingSpot athletic2 = new HidingSpot("", "", CampusMap.athleticField, 0.75);
        HidingSpot athletic3 = new HidingSpot("", "", CampusMap.athleticField, 0.75);
        HidingSpot paradise1 = new HidingSpot("", "", CampusMap.paradiseWoods, 1.5);
        HidingSpot paradise2 = new HidingSpot("", "", CampusMap.paradiseWoods, 1.5);
        HidingSpot paradise3 = new HidingSpot("", "", CampusMap.paradiseWoods, 1.25);
        // add hiding spots to master list
        masterHidingSpots.add(chapin1);
        masterHidingSpots.add(chapin2);
        masterHidingSpots.add(chapin3);
        masterHidingSpots.add(capenGazebo);
        masterHidingSpots.add(capenPorch);
        masterHidingSpots.add(capenFlowers);
